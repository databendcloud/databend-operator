	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DatabendlabsV1alpha1().Tenants(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DatabendlabsV1alpha1().Tenants(namespace).Watch(context.TODO(), options)
			},
		},
		&databendlabsiov1alpha1.Tenant{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *tenantInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&databendlabsiov1alpha1.Tenant{}, f.defaultInformer)
}
