...
func (c *FakeTenants) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TenantList, err error) {
	emptyResult := &v1alpha1.TenantList{}
	obj, err := c.Fake.
...
func (c *FakeTenants) UpdateStatus(ctx context.Context, tenant *v1alpha1.Tenant, opts v1.UpdateOptions) (result *v1alpha1.Tenant, err error) {
	emptyResult := &v1alpha1.Tenant{}
	obj, err := c.Fake.
...
func (c *FakeTenants) Apply(ctx context.Context, tenant *databendlabsiov1alpha1.TenantApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Tenant, err error) {
	if tenant == nil {
...
func (c *FakeTenants) ApplyStatus(ctx context.Context, tenant *databendlabsiov1alpha1.TenantApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Tenant, err error) {
	if tenant == nil {
		return nil, fmt.Errorf("tenant provided to Apply must not be nil")
	}
	data, err := json.Marshal(tenant)
