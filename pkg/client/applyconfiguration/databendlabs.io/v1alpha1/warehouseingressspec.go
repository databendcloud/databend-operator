...
func (b *WarehouseIngressSpecApplyConfiguration) WithAnnotations(entries map[string]string) *WarehouseIngressSpecApplyConfiguration {
...
func (b *WarehouseIngressSpecApplyConfiguration) WithIngressClassName(value string) *WarehouseIngressSpecApplyConfiguration {
...
func (b *WarehouseIngressSpecApplyConfiguration) WithHostName(value string) *WarehouseIngressSpecApplyConfiguration {
	b.HostName = &value
	return b
}
