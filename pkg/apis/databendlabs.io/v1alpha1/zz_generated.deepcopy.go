...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StderrLogSpec) DeepCopyInto(out *StderrLogSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StderrLogSpec.
func (in *StderrLogSpec) DeepCopy() *StderrLogSpec {
	if in == nil {
		return nil
	}
	out := new(StderrLogSpec)
	in.DeepCopyInto(out)
	return out
}
